...
os.environ.setdefault("LLM_BASE_URL", "https://test.api.local/v1")
os.environ.setdefault("LLM_MODEL_PRO",  "test-model-pro")
os.environ.setdefault("LLM_MODEL_MINI", "test-model-mini")
os.environ.setdefault("LLM_MODEL_LITE", "test-model-lite")
os.environ.setdefault("LLM_MODEL_CODE", "test-model-code")
